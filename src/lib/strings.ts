...
export const normalizeGuess = (value: string): string => compact(value);

export const equalsAlias = (guess: string, aliases: string[]): boolean => {
...
export const parseHumanNumber = (value: string): number | null => {
